...
function myshop_enqueue_scripts()
{
    ...
    wp_enqueue_script('myshop-bundle', get_template_directory_uri() . '/assets/js/dist/bundle.min.js', array('jquery'), '1.0.0', true);
    ...
    // Localize script for AJAX - bundle includes main.js and cart.js
    wp_localize_script('myshop-bundle', 'wc_add_to_cart_params', array(
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce'    => wp_create_nonce('wc_add_to_cart_nonce')
    ));

    wp_localize_script('myshop-bundle', 'skal_ajax', array(
        'ajax_url' => admin_url('admin-ajax.php'),
