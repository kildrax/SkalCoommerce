...
$text = __( 'Notificación para informar que el pedido #%1$s de %2$s ha sido cancelado:', 'woocommerce' );
if ( $email_improvements_enabled ) {
	/* translators: %1$s: Order number. %2$s: Customer full name */
	$text = __( 'Nos ponemos en contacto para informarte que el pedido #%1$s de %2$s ha sido cancelado.', 'woocommerce' );
}
?>
